    ...
    <div id="registration_blocks">
      <table class="form-layout-compressed">
       ...
       {/if}
        ...
        <tr class="crm-event-manage-registration-form-block-allow_same_participant_emails">
            <td scope="row" class="label" width="20%">{$form.allow_same_participant_emails_same_event.label}</td>
            <td>{$form.allow_same_participant_emails_same_event.html}</td>
        </tr>


        <tr class="crm-event-manage-registration-form-block-allow_same_participant_emails_take_multple">
            <td scope="row" class="label" width="20%">{$form.allow_same_participant_emails_take_multple.label}</td>
            <td>{$form.allow_same_participant_emails_take_multple.html}</td>
        </tr>        
