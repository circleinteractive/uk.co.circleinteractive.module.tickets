...
class CRM_Event_Ticket_TiXQR extends CRM_Event_Ticket {
    ...
    public function printHeader() {
        ...
        if ($this->preview) {
            ...
            if (!$result['is_error'] and $result['count']) {
                ...
                if (isset($result['values'][BDATIX_CUSTOMFIELD_VARTEXT1]))
                    $this->event['custom_' . BDATIX_CUSTOMFIELD_VARTEXT1] = 
                        $result['values'][BDATIX_CUSTOMFIELD_VARTEXT1]['latest'];
                
                if (isset($result['values'][BDATIX_CUSTOMFIELD_VARTEXT1]))
                    $this->event['custom_' . BDATIX_CUSTOMFIELD_VARTEXT2] = 
                        $result['values'][BDATIX_CUSTOMFIELD_VARTEXT2]['latest'];
                
                if (isset($result['values'][BDATIX_CUSTOMFIELD_VARTEXT3]))
                    $this->event['custom_' . BDATIX_CUSTOMFIELD_VARTEXT3] = 
                        $result['values'][BDATIX_CUSTOMFIELD_VARTEXT3]['latest'];
    ...
    public function printBody() {
        ...
        $pdf->write2DBarcode($barcode_number, 'QRCODE,H', 19.5, 39, 32, 32);
        ...
        watchdog('andyw', 'printing image: <pre>' . print_r($this->event['custom_' . BDATIX_CUSTOMFIELD_IMAGE], true) . '</pre>');   
